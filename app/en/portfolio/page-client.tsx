...
import Loading from "@/app/trabajos/loading"
import { allProjects } from "@/app/en/portfolio/data"

const baseCategories = [
  { id: "todos", label: "All" },
  { id: "diseno-web", label: "Web Design" },
  { id: "tienda-online", label: "Online Store" },
  { id: "apps", label: "Apps" },
  { id: "marketing", label: "Marketing" },
  { id: "agentes-ia", label: "AI Agents" },
]
...
function TrabajosContent({
  ...
  const categories = useMemo(() => {
    ...
    return [
      { id: "todos", label: categoryLabels.get("todos") ?? "All" },
      ...
      <section className="relative pt-32 pb-20 lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-white/80 max-w-2xl mx-auto">
            Projects that speak for themselves. Discover how we help companies around the world grow in the digital world.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          {paginatedProjects.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-gray-500 text-lg">No projects found with those criteria.</p>
              <Button 
                variant="outline" 
                        ...
                        >
                          ...
                          <div className="p-6">
                            <div className="flex items-center gap-2 text-sm mb-3">
                              ...
                              <Link
                                href={`/en/portfolio?category=${project.category}`}
...
export default function TrabajosPageEnClient() {
  return (
    <Suspense fallback={<Loading />}>
      <TrabajosContent initialSearchTerm="" initialCategory="todos" />
    </Suspense>
  )
}